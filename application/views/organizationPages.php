...
*/
  ...
  <body>
    ...
    <div id="page">  
    	...
    	<div class="container">
    		<div class="row">
    			<h1 id="heading"><?php //echo $res['scholarship']['name']; ?> كافة المنظمات</h1>
    		</div>
    		<?php
    			foreach ($organizations as $key => $organization) {
    				...
    				echo '
    					<div class="row" >
    					<div class="col-xs-9" id="organization">
    						<h4 id="see-more-header-content">
    							<a id="scholar-link" href="'.
    							site_url('organization/show_organization').'/'.$organization['organization_id']
    							.'">'.
    							$organization['organization_name'].'</a>
    						</h4>'
    				;
    				//foreach ($organization['details'] as $key => $details) {
    					echo '
							...
							echo '
								...
								<p style="padding: 0;">عدد المنح: '.
								$organization['scholarship_count'].
								'
								</p>
