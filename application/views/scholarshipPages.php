...
*/
  ...
  <body>
    ...
    <div id="page">  
    	...
    	<div class="container">
    		<div class="row">
    			<h1 id="heading"><?php //echo $res['scholarship']['name']; ?> كافة المنح</h1>
    		</div>
    		<?php
    			foreach ($scholarships as $key => $scholarship) {
    				...
    				echo '
    					...
    					<div class="col-xs-9" id="institute">
    						<h4 id="see-more-header-content">
    							...
    							.'">'.
    							$scholarship['scholarship_name'].'</a>
    						</h4>'
    				;
    				echo '
    				...
    				';
    				echo '<div id="see-more-content">
    						<p id="country">الدرجة العملية: </p>';
    				foreach ($scholarship['details'] as $key => $details) {
    					echo '
